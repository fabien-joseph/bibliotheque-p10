...
-- Started on 2019-09-22 22:49:08
...
-- Name: hibernate_sequence; Type: SEQUENCE; Schema: public; Owner: fabien
--
...
ALTER TABLE public.hibernate_sequence OWNER TO fabien;
...
-- Name: livre; Type: TABLE; Schema: public; Owner: fabien
--
...
ALTER TABLE public.livre OWNER TO fabien;

--
-- TOC entry 199 (class 1259 OID 197851)
-- Name: reservation; Type: TABLE; Schema: public; Owner: fabien
--
...
ALTER TABLE public.reservation OWNER TO fabien;

--
-- TOC entry 198 (class 1259 OID 197833)
-- Name: utilisateur; Type: TABLE; Schema: public; Owner: fabien
--
...
ALTER TABLE public.utilisateur OWNER TO fabien;

--
-- TOC entry 2812 (class 0 OID 181217)
-- Dependencies: 197
-- Data for Name: livre; Type: TABLE DATA; Schema: public; Owner: fabien
--
...
-- Dependencies: 199
-- Data for Name: reservation; Type: TABLE DATA; Schema: public; Owner: fabien
--
...
9	2019-08-24 22:24:56	7	3	f	t
8	2019-08-24 22:24:56	6	3	f	t
...
-- Dependencies: 198
-- Data for Name: utilisateur; Type: TABLE DATA; Schema: public; Owner: fabien
--

COPY public.utilisateur (id, date_creation, is_bibliothecaire, mail, mot_de_passe, nom, prenom) FROM stdin;
3	2019-08-24 14:49:43.988	f	utilisateur@orange.fr	$2a$10$trUg8Vhd2YqVUKxwsKqnT..JELVnr0U3u8h9Xj/PpjS5R7172dvJC	Utilisateur	Utilisateur
...
-- Dependencies: 196
-- Name: hibernate_sequence; Type: SEQUENCE SET; Schema: public; Owner: fabien
--
...
-- Name: livre livre_pkey; Type: CONSTRAINT; Schema: public; Owner: fabien
--
...
-- Name: reservation reservation_pkey; Type: CONSTRAINT; Schema: public; Owner: fabien
--
...
-- Name: utilisateur utilisateur_pkey; Type: CONSTRAINT; Schema: public; Owner: fabien
--
...
-- Name: reservation fk7age5yb4rno7mnt26auu4403c; Type: FK CONSTRAINT; Schema: public; Owner: fabien
--
...
-- Name: reservation fkbtwk47ayb3rwdyr6uqp7dsgr2; Type: FK CONSTRAINT; Schema: public; Owner: fabien
--
...
-- Completed on 2019-09-22 22:49:09
